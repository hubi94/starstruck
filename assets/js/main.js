$(document).ready(function(){
	...
	for(let i = 0; i < articleHeaders.length; i++){
		article += `<div class="col-4 col-6-medium col-12-small">
						<section class="box style1">
							<span class="image"><img src="images/articles/article${[i+1]}.webp" alt="img${[i+1]}"></span>
	...
	let products = [
		...
		{
			'name' : 'SILVER AND GOLD MANDALA PATTERN',
			'price': 3,
			'theme' : 'mandala',
			'img' : {
				'src' : 'mandala1',
		...
		let product = '';
		products.forEach(p => {
			product += `<div class="col-4 col-6-medium col-12-small">
